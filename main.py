...
def attack(char_name: str, char_class: str) -> str or None:
    """Описание атаки каждого класса."""
...
def defence(char_name: str, char_class: str) -> str or None:
    """Описание защиты каждого класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str or None:
...
def start_training(char_name: str, char_class: str) -> str:
    """Проверка умений персонажа - тренировка."""
    if char_class == 'warrior':
